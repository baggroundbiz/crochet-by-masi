    ...
    productsToRender.forEach(product => {
        ...
        card.innerHTML = `
            ...
            <div class="product-info">
                ...
                <div class="product-footer" style="display: flex; justify-content: space-between; align-items: center; margin-top: auto; padding-top: 1rem;">
                    <span class="product-price">${formattedPrice}</span>
                    
                    <!-- NEW: Circular Icon Buttons -->
                    <div class="icon-actions" style="display: flex; gap: 0.8rem;">
                        <a href="${instagramLink}" class="btn-icon ig-icon" target="_blank" rel="noopener noreferrer" aria-label="DM on Instagram">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                        </a>
                        <a href="${whatsappLink}" class="btn-icon wa-icon" target="_blank" rel="noopener noreferrer" aria-label="Order on WhatsApp">
